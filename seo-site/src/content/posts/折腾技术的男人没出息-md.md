...
AI 火了这么久，的确很多工具让我们的工作效率提升了，甚至有了很多想象力可以成真，比如和 AI 马斯克对话，或者让马斯克实时说中文，还有前阵子火过的用英语讲相声的郭德纲，和 AI 孙燕姿。

  

施密特在 MIT 的演讲说，每过半年 AI 技术就会迭代一次，所以这么来说其实我们现在 24 年可能用的还是 23 年的最新科技而已，GPT 的新模型据说也要发布了，距离自然语言编程越来越近了。
...
今天折腾了很久一个叫做 VideoReTalking 的开源项目，刚好公司有一台 Win 系统的 N 卡，装好了 Python 和 ffmpeg 的环境，期待的点击 bat 文件，然后接二连三的报错。
...
运气差的是，不知道是 win 的系统问题还是硬件问题，时不时系统也会报错，原本为了运行程序，最后还得解决电脑问题，这么折腾一天如果还得不到想要的答案，要么放弃，要么花钱找外援了。
...
为了避免用付费软件，于是去找开源软件，然后需要去搭环境，堆硬件，解决问题，最后发现还不如买起初的付费服务，虽然心里知道不过是套壳的 SaaS 而已，但的确自己搞不定傻瓜化操作，这就是中介的意义吧。
